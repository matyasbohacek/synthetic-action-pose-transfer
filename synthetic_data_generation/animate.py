...
def main():
    ...
    # load ID information
    root_path = osp.join('..', '..', 'fitting', 'data', cfg.dataset, 'data', cfg.subject_id)
    ...
    cleaned_id = subject_id.split('/')[-1]
    video_out = cv2.VideoWriter(f'new_wacv_videos/{motion_name}_{random_number}_{cleaned_id}' + '.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30, (render_shape[1], render_shape[0]))
